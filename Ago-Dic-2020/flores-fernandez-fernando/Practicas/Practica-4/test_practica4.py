...
class SchoolMemberFactoryTest(unittest.TestCase):
    def test_student_creation(self):
        ...
        self.assertEqual(str(student), "Soy foo!, tengo -1 años y mi ID = XXXXXX")
        
    def test_teacher_creation(self):
        teacher = SchoolMemberFactory.make(kind = "teacher", name = "bar")
        self.assertEqual(str(teacher), "Soy bar!, tengo -1 años y mi ID = XXXXXX")
    
    def test_visitor_creation(self):
        visitor = SchoolMemberFactory.make(kind = "visitor", name = "fer")
        self.assertEqual(str(visitor), "Soy fer!, tengo -1 años y mi ID = XXXXXX")    
        
    def test_creation_with_multiple_case(self):
        teacher = SchoolMemberFactory.make(kind = "tEaCHer", name = "baz")
        self.assertEqual(str(teacher), "Soy baz!, tengo -1 años y mi ID = XXXXXX")
    ...
    def test_student_with_attributes(self):
        ...
        self.assertEqual(str(student), "Soy fer!, tengo 23 años y mi ID = 002547")   
