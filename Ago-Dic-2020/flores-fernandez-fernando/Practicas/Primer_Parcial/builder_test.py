...
class BuilderTest(unittest.TestCase):
    ...
    def test_pizza_con_todo_20_pulgadas(self):
        ...
        builder.addCebolla()
        builder.addChampinones()
        pizza = builder.build()

        self.assertIsInstance(pizza, Pizza)
        self.assertEqual(
            'Mi pizza es de 20" con los siguientes ingredientes: salsa de tomate, queso, doble queso, pepperoni, salami, pimientos, cebolla y champinones',
            str(pizza)
        )
