class Persona():
    ...
    def pesoideal(self):
        ...
        return f"El peso ideal de esta persona es de: {self.peso_ideal}"
...
class Estudiante(Persona):
    ...
    def descripcion(self):
        return f"{self.nombre} tiene {self.edad} años, su peso es de {self.peso}y su altura es de {self.altura} cm."
