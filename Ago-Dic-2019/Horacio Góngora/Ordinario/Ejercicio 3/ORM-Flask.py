    ...
    return f'''<!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <div align="center"><img src="static/Rick_and_Morty_logo.png"></div>
            </head>
            <body>
