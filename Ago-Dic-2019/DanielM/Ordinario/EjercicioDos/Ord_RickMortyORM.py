...
def create_conncect():
    db.connect()
    db.create_tables([Characters, Location, Episode], safe=True)


def get_character():
    lista = []
    characters = Characters.select(Characters.id, Characters.name, Characters.status, Characters.species, Characters.tipe, Characters.gender, Characters.nameOrigin, Characters.urlOrigin,
                                   Characters.nameLocation, Characters.urlLocation, Characters.image, Characters.episodes, Characters.url, Characters.created)
    for i in characters:
        lista.append(i)
    return lista
    ...
    string_html = f'''<!DOCTYPE html>
            <html lang="en">
                ...
                <body>
                    ...
                    <br><a href="Personajes/17.html" target="_blank"><h1 align="center">{list_nombres[16]}</h1></a>
                    ...
                    <br><a href="Personajes/33.html" target="_blank"><h1 align="center">{list_nombres[32]}</h1></a>
                    ...
                    <br><a href="Personajes/49.html" target="_blank"><h1 align="center">{list_nombres[48]}</h1></a>
                    ...
                    <br><a href="Personajes/65.html" target="_blank"><h1 align="center">{list_nombres[64]}</h1></a>
                    ...
                    <br><a href="Personajes/75.html" target="_blank"><h1 align="center">{list_nombres[74]}</h1></a>
                    ...
                    <br><a href="Personajes/84.html" target="_blank"><h1 align="center">{list_nombres[83]}</h1></a>
                    <br><a href="Personajes/85.html" target="_blank"><h1 align="center">{list_nombres[84]}</h1></a>
                    <br><a href="Personajes/86.html" target="_blank"><h1 align="center">{list_nombres[85]}</h1></a>
                    <br><a href="Personajes/87.html" target="_blank"><h1 align="center">{list_nombres[86]}</h1></a>
                    <br><a href="Personajes/88.html" target="_blank"><h1 align="center">{list_nombres[87]}</h1></a>
                    <br><a href="Personajes/89.html" target="_blank"><h1 align="center">{list_nombres[88]}</h1></a>
...
def crear_indexEpisode():
    ...
    string_html = f'''<!DOCTYPE html>
                    <html lang="en">
                        ...
                        <body>
                            <br><a href="Episodios/1.html" target="_blank"><h1 align="center">{list_episode[0]}</h1></a>
                            <br><a href="Episodios/2.html" target="_blank"><h1 align="center">{list_episode[1]}</h1></a>
                            <br><a href="Episodios/3.html" target="_blank"><h1 align="center">{list_episode[2]}</h1></a>
                            <br><a href="Episodios/4.html" target="_blank"><h1 align="center">{list_episode[3]}</h1></a>
                            <br><a href="Episodios/5.html" target="_blank"><h1 align="center">{list_episode[4]}</h1></a>
                            <br><a href="Episodios/6.html" target="_blank"><h1 align="center">{list_episode[5]}</h1></a>
                            <br><a href="Episodios/7.html" target="_blank"><h1 align="center">{list_episode[6]}</h1></a>
                            <br><a href="Episodios/8.html" target="_blank"><h1 align="center">{list_episode[7]}</h1></a>
                            <br><a href="Episodios/9.html" target="_blank"><h1 align="center">{list_episode[8]}</h1></a>
                            <br><a href="Episodios/10.html" target="_blank"><h1 align="center">{list_episode[9]}</h1></a>
                            <br><a href="Episodios/11.html" target="_blank"><h1 align="center">{list_episode[10]}</h1></a>
                            <br><a href="Episodios/12.html" target="_blank"><h1 align="center">{list_episode[11]}</h1></a>
                            <br><a href="Episodios/13.html" target="_blank"><h1 align="center">{list_episode[12]}</h1></a>
                            <br><a href="Episodios/14.html" target="_blank"><h1 align="center">{list_episode[13]}</h1></a>
                            <br><a href="Episodios/15.html" target="_blank"><h1 align="center">{list_episode[14]}</h1></a>
                            <br><a href="Episodios/16.html" target="_blank"><h1 align="center">{list_episode[15]}</h1></a>
                            <br><a href="Episodios/17.html" target="_blank"><h1 align="center">{list_episode[16]}</h1></a>
                            <br><a href="Episodios/18.html" target="_blank"><h1 align="center">{list_episode[17]}</h1></a>
                            <br><a href="Episodios/19.html" target="_blank"><h1 align="center">{list_episode[18]}</h1></a>
                            <br><a href="Episodios/20.html" target="_blank"><h1 align="center">{list_episode[19]}</h1></a>
                            <br><a href="Episodios/21.html" target="_blank"><h1 align="center">{list_episode[20]}</h1></a>
                            <br><a href="Episodios/22.html" target="_blank"><h1 align="center">{list_episode[21]}</h1></a>
                            <br><a href="Episodios/23.html" target="_blank"><h1 align="center">{list_episode[22]}</h1></a>
                            <br><a href="Episodios/24.html" target="_blank"><h1 align="center">{list_episode[23]}</h1></a>
                            <br><a href="Episodios/25.html" target="_blank"><h1 align="center">{list_episode[24]}</h1></a>
                            <br><a href="Episodios/26.html" target="_blank"><h1 align="center">{list_episode[25]}</h1></a>
                            <br><a href="Episodios/27.html" target="_blank"><h1 align="center">{list_episode[26]}</h1></a>
                            <br><a href="Episodios/28.html" target="_blank"><h1 align="center">{list_episode[27]}</h1></a>
                            <br><a href="Episodios/29.html" target="_blank"><h1 align="center">{list_episode[28]}</h1></a>
                            <br><a href="Episodios/30.html" target="_blank"><h1 align="center">{list_episode[29]}</h1></a>
                            <br><a href="Episodios/31.html" target="_blank"><h1 align="center">{list_episode[30]}</h1></a>
                        </body>
                    </html>
                    '''
        ...
        string_html = f'''<!DOCTYPE html>
                                <html lang="en">
                                    <head>
                                        ...
                                        <div align="center"><img src="Rick_and_Morty_logo.png"></div>
                                        <div><a href="../Diseño y Arquitectura de Software/locations-index.html" target="_blank"><h1 align="left">Menu</h1></a></div>
                                    </head>
                                    <body>
                                        <br><h1 align="center">Id -> {i.id}</h1></a>
                                        <br><h1 align="center">Name -> {i.name}</h1></a>
