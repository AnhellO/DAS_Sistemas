...
def conseguirUsers():
    ...
    if r.status_code == 200:
        response = r.json()
        infoUser = []
        #Llenando array con las datos del JSON
...
def guardarUser(usr):
    try:
        ...
        cursor.execute("INSERT INTO usuarios VALUES ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(usr._id,usr._name,usr._username,usr._email,usr._street,usr._suite,usr._city,usr._zipcode,usr._lat,usr._lng,usr._phone,usr._website,usr._nameC,usr._catchPhrase,usr._bs))
        conexion.commit()
        cursor.close()
