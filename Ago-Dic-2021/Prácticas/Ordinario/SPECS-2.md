...
La mascota elegida para este equipo son los patos :duck:: <https://random-d.uk/api>. Cada mascota debe estar bautizada con un nombre :wink:.

Las personas deberán de tener un nombre, apellido e imágen, y se obtendrán aleatoriamente desde el API <https://thispersondoesnotexist.com/>.
...
* El motor de base de datos asignado para este equipo es `Redis`
