...
#######################################
# Estructuras de control y de flujo/iteración
#######################################
...
copia_lista.clear()
while copia_lista: # [] evalúa a False
...
# Función map(): https://www.w3schools.com/python/ref_func_map.asp
animales = ['gato', 'perro', 'oso', 'león', 'ballena']
