...
class basedatos(AbstractbaseTacos):
    def __init__(self):
        self.conn=sqlite3.connect("El_primo_Vela.db")
    ...
    def insertarTaco_db(self,id_taco,Taco):
        ...
        self.cursor.execute(''' INSERT INTO Tacos VALUES (?,?,?,?,?,?,?)''',t)
        self.conn.commit()
        # ('Datos Insertados ({}, {}, {}, {}, {}, {}, {})'.format(id_taco,Taco.nombre,Taco.capa_base,Taco.salsas,Taco.condimentos,Taco.sasonadores,Taco.capas))
        return True
    ...
    def insertarCliente_db(self,id_cliente,cliente):
        ...
        self.conn.commit()
        #print ('Datos Insertados ({}, {}, {}, {}, {})'.format(id_cliente,cliente.name,cliente.email,cliente.phone,cliente.location))
        return True
    ...
    def selectTaco(self):
            self.cursor.execute("SELECT id_taco,Nombre FROM Tacos group by Nombre order by id_taco")
