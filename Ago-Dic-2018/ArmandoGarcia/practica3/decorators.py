def memoize(fn):#funcion hace caching de los resultados de una funcion
...
#La pasamos a memoize la funcion que vamos a decorar
    def wrapper(*args, **kwargs):
        ...
        return cache[args]# si no existe lo guardamos y si existe regresamos lo que este en el cache(diccionario)
    return wrapper
