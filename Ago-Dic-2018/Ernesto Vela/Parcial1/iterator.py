...
#LOGICA IMPLEMENTADA EN MI ENFOQUE
#Elimine el siguiente elemento de mi coleccion de objetos
#Y recorri los elementos restantes de mi coleccion
#LA utilidad de deste patron fue imprimir los objetos
#como tales en vez de su lugar memoria
