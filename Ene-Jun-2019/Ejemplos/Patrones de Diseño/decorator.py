...
class Canela_Decorador(Abstracta_Decorador):
...
class Leche_Decorador(Abstracta_Decorador):
...
#Tipo de Decorador(en este caso ingrediente), implementa la clase abstracta de Decorador de arriba (Abstract_Coffee_Decorator)
class Vainilla_Decorador(Abstracta_Decorador):
