...
# Elabore una clase Figura. De esta clase heredarán las clases Circulo,
# Triangulo y Rectangulo:
# Para cada clase, agregar la función area
# Para cada clase, sobreescribe la función __str__,
# para poder obtener una representación del objeto como string
# Para finalizar, crean la función (main), en la cual instancies y juegues
# con al menos 5 objetos diferentes (en total) para cada una de las clases
